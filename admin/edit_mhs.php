...
if (isset($_POST['submit'])) {
    ...
    $query_dp = mysqli_query($koneksi, "UPDATE dosen_pembimbing SET dosen_pembimbing1 = '$dp1' WHERE nim_mhs = '$nim';") or die(mysqli_error($koneksi));
    if ($query_mhs && $query_regis && $query_dp) {
        echo '<script>alert("Berhasil Mengubah Data."); document.location="index.php?page=kelola_mhs";</script>';
    } else {
