                    ...
                    while ($data_mhs = mysqli_fetch_assoc($sql_mhs)) {
                        echo '
							...
							<td class="text-center">
								<a href="index.php?page=upload_sk&nim=' . $data_mhs['NIM'] . '" class="btn btn-secondary btn-sm">Upload Sk</a>
                                <a href="index.php?page=tampil_sk&nim=' . $data_mhs['NIM'] . '" class="btn btn-secondary btn-sm">tampil Sk</a>
							</td>
							</tr>
						';
                        $no++;
