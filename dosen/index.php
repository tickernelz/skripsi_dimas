                        ...
                        <ul class="nav side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav child_menu">
                                    <li><a href="index.php?page=data_mhs">Mahasiswa</a></li>
                                    <li><a href="index.php?page=data_proposal">Penilaian Proposal</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="#">
                                ...
                                <ul class="nav child_menu">
                                    <li><a href="index.php?page=tampil_jadwal">Jadwla Sidang Propsoal</a></li>
                                    <li><a href="index.php?page=tampil_skp">Sk Perpanjangan</a></li>
                                </ul>
                            </li>
                    </div>
                </div>
                    ...
                    <ul class=" navbar-right">
                        <li class="nav-item dropdown open">
                            <div class="user-profile" aria-expanded="false">
                                <img src="assets/images/logo-upr.jpeg" alt=""> <?php echo $_SESSION['nama']; ?>
                            </div>
                        </li>
                    </ul>
                </nav>
