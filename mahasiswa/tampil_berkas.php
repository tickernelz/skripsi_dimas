...
<div class="container-fluid">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
							...
							<div>
								...
								<div style="text-align: center;">
								    <a href="' . $filektm . '" target="_blank"><button class="btn btn-success">View pdf</button></a>
                                </div>
                            </div>
                                ';
                            } else {
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
							...
							<div>
								...
								<div style="text-align: center;">
								    <a href="' . $filetr . '" target="_blank"><button class="btn btn-success">View pdf</button></a>
                                </div>
                            </div>
                                ';
                            } else {
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
							...
							<div>
								...
								<div style="text-align: center;">
								    <a href="' . $fileukt . '" target="_blank"><button class="btn btn-success">View pdf</button></a>
                                </div>
                            </div>
                                ';
                            } else {
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
							...
							<div>
								...
								<div style="text-align: center;">
								    <a href="' . $filekh . '" target="_blank"><button class="btn btn-success">View pdf</button></a>
                                </div>
                            </div>
                                ';
                            } else {
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
							...
							<div>
								...
								<div style="text-align: center;">
								    <a href="' . $filekt . '" target="_blank"><button class="btn btn-success">View pdf</button></a>
                                </div>
                            </div>
                                ';
                            } else {
    ...
    <div class="card border-left-success shadow h-100 py-2">
        <div class="card-body">
            ...
            <textarea name="pesan" class="ckeditor" disabled><?= $data_cmnt['comen'] ?></textarea>
            <br>
        </div>
    </div>
</div>
