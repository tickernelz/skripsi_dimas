...
$sql_nilai_berkas = "select * from nilai_berkas where nim='$username'";
$query_mhs = mysqli_query($koneksi, $sql_mhs);
$query_berkas = mysqli_query($koneksi, $sql_berkas);
$query_nilai_berkas = mysqli_query($koneksi, $sql_nilai_berkas);
$data_mhs = mysqli_fetch_assoc($query_mhs);
$data_berkas = mysqli_fetch_assoc($query_berkas);
$data_nilai_berkas = mysqli_fetch_assoc($query_nilai_berkas);
# Dosen
