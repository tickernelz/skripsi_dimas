...
$file_sk = $data_berkas['sk_perpanjangan'];
	...
	if ($sk_perpanjangan != "") {
		...
		if (in_array($ekstensi, $ekstensi_diperbolehkan) === true) {
			...
			if ($query) {
				...
				echo '<script>alert("Berhasil menambahkan data."); document.location="index.php?page=tampil_sk";</script>';
			} else {
				//jika file ekstensi tidak jpg dan png maka alert ini yang tampil
				echo "<script>alert('Ekstensi gambar yang boleh hanya pdf, jpg atau png.');window.location='tambah_produk.php';</script>";
			}
		}
	}
}
